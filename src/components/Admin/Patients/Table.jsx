      ...
      <table className="min-w-full table-auto border-8">
        <thead className="bg-gray-100 text-gray-600 uppercase text-sm leading-normal">
          <tr>
            ...
            <th className="py-3 px-6 text-center">Generate</th>
              ...
              return (
                ...
                >
                  ...
                  <td className="py-3 px-6 flex justify-center items-center">
                    <Link
                      to={`/review-panel/patient-invoice/?BranchID=${BranchID}&PatientID=${patient?._id}`}
                    >
                      <svg
                  ...
                  <td className="relative text-center">
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        toggleDropdown(patient?.PatientID);
                      }}
