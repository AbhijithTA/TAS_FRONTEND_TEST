    ...
    <div className="overflow-x-auto mt-6 ">
      <table className="border-collapse text-left bg-white min-w-full border-2 rounded-lg shadow-lg">
        <thead>
          <tr className="text-sm leading-normal text-gray-600 bg-gray-200">
            ...
            <th className="px-6 py-3 font-semibold uppercase border-b border-gray-300 text-xs text-center">
              Date
            </th>
            <th className="px-6 py-3 font-semibold uppercase border-b border-gray-300 text-xs text-center">
              Patient Name
            ...
            <th className="px-6 py-3 font-semibold uppercase border-b border-gray-300 text-xs text-center rounded-tr-lg">
              Action
            </th>
          </tr>
        </thead>
        <tbody className="text-sm font-light">
          {loader ? (
            ...
            data?.map((invoice, index) => (
              <tr
                key={index}
                className="border-b border-gray-300 even:bg-slate-100 odd:bg-white cursor-pointer"
              ...
              >
                ...
                <td
                  ...
                  className="px-6 py-3 border-gray-300 capitalize flex gap-3 justify-center items-center"
                >
                  <svg
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center z-[99]">
          ...
          <div
            id="invoicemodelid"
            className="relative bg-white p-4 mx-auto z-10 rounded-lg shadow-md print:w-full print:h-full w-[75%]"
          >
