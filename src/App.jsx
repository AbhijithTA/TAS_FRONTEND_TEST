...
function App() {
  return (
    <>
      <Routes>
        {/* Branch */}
        <Route path="/login"element={<PublicRoute><Branch_Login/></PublicRoute>}/>
        {/* User */}
        <Route path="/user-login" element={ <UserAuthRoute> <Employee_Login /> </UserAuthRoute> } />
        
        {/* Reception panel */}
        <Route path="/" element={ <RoleBasedRoute requiredRole={import.meta.env.VITE_ROLE_USER}> <Reception_Panel_Template /> </RoleBasedRoute> } >
        ...
        {/* Review panel */}
        <Route path="review-panel/" element={ <RoleBasedRoute requiredRole={import.meta.env.VITE_ROLE_ADMIN}> <Admin_Panel_Template /> </RoleBasedRoute> }>
        ...
        <Route path="doctor-panel/" element={<RoleBasedRoute requiredRole={import.meta.env.VITE_ROLE_DOCTOR}> <Doctor_Panel_Template /> </RoleBasedRoute>}  >
